package com.cyanogenmod.filemanager.sambaexplorer.SambaExplorer;
...
public class SambaExplorer extends android.app.ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     //   mSubnetOverride = intent.getStringExtra("subnet");
        ...
        if (mHost == null) {
        	...
        	//startActivity(new Intent(this,com.cyanogenmod.filemanager.SambaExplorer.PickHost.class));
        	
        	try{
        		Intent i = new Intent("com.cyanogenmod.filemanager.portscan.PortScan.class");
        		startActivity(i);
			...
			try {
				...
				startActivity(new Intent(this, com.cyanogenmod.filemanager.SambaExplorer.SambaLogin.class).putExtra("path", mHost));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case 2:
        	Intent intent = new Intent(this, com.cyanogenmod.filemanager.SambaExplorer.DownloadQueue.class);
    		startActivity(intent);
        	break;
        }
        return false;
        ...
        try{
	        ...
	        for(int i = 0; l != null && i < l.length; i++ ) {
	            try {
					...
					startActivity(new Intent(this, com.cyanogenmod.filemanager.SambaExplorer.SambaLogin.class).putExtra("path", l[i].getCanonicalPath()));
			...
			startActivity(new Intent(this, com.cyanogenmod.filemanager.SambaExplorer.SambaLogin.class).putExtra("path", f.getCanonicalPath()));
        }catch(Exception e){
        	AddListItem(e.toString());
        }
    }
