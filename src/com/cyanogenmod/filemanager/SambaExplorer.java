...
public class SambaExplorer extends android.app.ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     //   mSubnetOverride = intent.getStringExtra("subnet");
        ...
        if (mHost == null) {
                ...
                //startActivity(new Intent(this,com.cyanogenmod.filemanager.PickHost.class));
                ...
                SmbFile f;
                        ...
                        if (f.canRead()) {
                                ...
                                startActivity(new Intent(this, com.cyanogenmod.filemanager.SambaLogin.class).putExtra("path", mHost));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case 2:
                Intent intent = new Intent(this, com.cyanogenmod.filemanager.DownloadQueue.class);
                startActivity(intent);
                break;
        }
        return false;
                    ...
                    try {
                        ...
                        if( l[i].isDirectory() ) {
                            TraverseSMB( l[i], depth - 1 );
                                        ...
                                        startActivity(new Intent(this, com.cyanogenmod.filemanager.SambaLogin.class).putExtra("path", l[i].getCanonicalPath()));
                        ...
                        startActivity(new Intent(this, com.cyanogenmod.filemanager.SambaLogin.class).putExtra("path", f.getCanonicalPath()));
        }catch(Exception e){
                AddListItem(e.toString());
        }
    }
